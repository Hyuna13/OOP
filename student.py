...
# 학생 인스턴스 정의
taylor = Student("Taylor", 20120034, "Business")
taylor.profile.change_info("Taylor", 20130024, "Computer Science")

# 학생 성적 추가
taylor.gpa_manager.add_grade(3.0)
taylor.gpa_manager.add_grade(3.33)
taylor.gpa_manager.add_grade(3.67)
taylor.gpa_manager.add_grade(4.3)

# 학생 성적표 
taylor.report_card_printer.print()
